...
def m15_scalp_strategy(historical_data: pd.DataFrame, symbol: str = "BTCUSDT") -> Dict:
    """
    استراتيجية سكالبينج 15 دقيقة
    """
    ...
    try:
        ...
        logger.error(f"خطأ في استراتيجية M15 لـ {symbol}: {e}")
        return {
            'action': 'HOLD',
            'confidence': 0.0,
