...
def m5_scalp_strategy(symbol: str, strict: bool = True) -> Tuple[List[WavePattern], pd.DataFrame]:
    """
    Fetches 5-minute data, runs Elliott Wave analysis, and returns the patterns
