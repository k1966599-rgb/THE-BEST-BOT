...
def m3_scalp_strategy(historical_data: pd.DataFrame, symbol: str = "BTCUSDT") -> Dict:
    """
    استراتيجية سكالبينج 3 دقائق
    """
    ...
    try:
        ...
        logger.error(f"خطأ في استراتيجية M3 لـ {symbol}: {e}")
        return {
            'action': 'HOLD',
            'confidence': 0.0,
